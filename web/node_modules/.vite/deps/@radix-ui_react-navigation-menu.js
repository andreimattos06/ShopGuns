...
// node_modules/@radix-ui/react-navigation-menu/node_modules/@radix-ui/react-primitive/dist/index.module.js
var import_react2 = __toESM(require_react());
var import_react_dom = __toESM(require_react_dom());

// node_modules/@radix-ui/react-navigation-menu/node_modules/@radix-ui/react-slot/dist/index.module.js
...
// node_modules/@radix-ui/react-navigation-menu/node_modules/@radix-ui/react-collection/dist/index.module.js
...
// node_modules/@radix-ui/react-navigation-menu/node_modules/@radix-ui/react-dismissable-layer/dist/index.module.js
var import_react5 = __toESM(require_react());

// node_modules/@radix-ui/react-navigation-menu/node_modules/@radix-ui/react-use-escape-keydown/dist/index.module.js
...
// node_modules/@radix-ui/react-navigation-menu/node_modules/@radix-ui/react-visually-hidden/dist/index.module.js
...
var $322c88a641701f3b$export$5b2278cf1e8bcae2 = (0, import_react7.forwardRef)((props, forwardedRef) => {
  ...
  const [navigationMenu, setNavigationMenu] = (0, import_react7.useState)(null);
  ...
  const closeTimerRef = (0, import_react7.useRef)(0);
  ...
  const startCloseTimer = (0, import_react7.useCallback)(() => {
  ...
  const handleOpen = (0, import_react7.useCallback)((itemValue) => {
    window.clearTimeout(closeTimerRef.current);
    setValue(itemValue);
  }, [
    setValue
  ]);
  const handleDelayedOpen = (0, import_react7.useCallback)((itemValue) => {
  ...
  return (0, import_react7.createElement)($322c88a641701f3b$var$NavigationMenuProvider, {
  ...
  }, (0, import_react7.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.nav, _extends({
    "aria-label": "Main",
...
var $322c88a641701f3b$export$5958edd6c4ee7c79 = (0, import_react7.forwardRef)((props, forwardedRef) => {
...
var $322c88a641701f3b$var$NavigationMenuProvider = (props) => {
  ...
  const [viewportContent, setViewportContent] = (0, import_react7.useState)(/* @__PURE__ */ new Map());
  const [indicatorTrack, setIndicatorTrack] = (0, import_react7.useState)(null);
  return (0, import_react7.createElement)($322c88a641701f3b$var$NavigationMenuProviderImpl, {
    scope,
    isRootMenu,
    rootNavigationMenu,
    value,
    ...
    onViewportContentChange: (0, import_react7.useCallback)((contentValue, contentData) => {
      setViewportContent((prevContent) => {
        prevContent.set(contentValue, contentData);
        return new Map(prevContent);
      });
    }, []),
    onViewportContentRemove: (0, import_react7.useCallback)((contentValue) => {
      setViewportContent((prevContent) => {
  ...
  }, (0, import_react7.createElement)($322c88a641701f3b$var$Collection.Provider, {
    scope
  }, (0, import_react7.createElement)($322c88a641701f3b$var$ViewportContentProvider, {
    scope,
    items: viewportContent
  }, children)));
};
var $322c88a641701f3b$var$LIST_NAME = "NavigationMenuList";
var $322c88a641701f3b$export$c361068a95fd2286 = (0, import_react7.forwardRef)((props, forwardedRef) => {
  const { __scopeNavigationMenu, ...listProps } = props;
  const context = $322c88a641701f3b$var$useNavigationMenuContext($322c88a641701f3b$var$LIST_NAME, __scopeNavigationMenu);
  const list = (0, import_react7.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.ul, _extends({
    "data-orientation": context.orientation
  }, listProps, {
    ref: forwardedRef
  }));
  return (0, import_react7.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, {
    style: {
      position: "relative"
    },
    ref: context.onIndicatorTrackChange
  }, (0, import_react7.createElement)($322c88a641701f3b$var$Collection.Slot, {
    scope: __scopeNavigationMenu
  }, context.isRootMenu ? (0, import_react7.createElement)($322c88a641701f3b$var$FocusGroup, {
    asChild: true
  }, list) : list));
});
...
var $322c88a641701f3b$export$ffdbb83a2de845c2 = (0, import_react7.forwardRef)((props, forwardedRef) => {
  ...
  const focusProxyRef = (0, import_react7.useRef)(null);
  const restoreContentTabOrderRef = (0, import_react7.useRef)(() => {
  });
  const wasEscapeCloseRef = (0, import_react7.useRef)(false);
  const handleContentEntry = (0, import_react7.useCallback)((side = "start") => {
  ...
  const handleContentExit = (0, import_react7.useCallback)(() => {
    if (contentRef.current) {
      const candidates = $322c88a641701f3b$var$getTabbableCandidates(contentRef.current);
      if (candidates.length)
  ...
  return (0, import_react7.createElement)($322c88a641701f3b$var$NavigationMenuItemContextProvider, {
    scope: __scopeNavigationMenu,
    value,
    triggerRef,
    contentRef,
  ...
  }, (0, import_react7.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.li, _extends({}, itemProps, {
    ref: forwardedRef
  })));
});
...
var $322c88a641701f3b$export$37fe8002734d8f2 = (0, import_react7.forwardRef)((props, forwardedRef) => {
  ...
  const wasClickCloseRef = (0, import_react7.useRef)(false);
  const open = itemContext.value === context.value;
  return (0, import_react7.createElement)(import_react7.Fragment, null, (0, import_react7.createElement)($322c88a641701f3b$var$Collection.ItemSlot, {
    scope: __scopeNavigationMenu,
    value: itemContext.value
  }, (0, import_react7.createElement)($322c88a641701f3b$var$FocusGroupItem, {
    asChild: true
  ...
  })))), open && (0, import_react7.createElement)(import_react7.Fragment, null, (0, import_react7.createElement)($ea1ef594cf570d83$export$be92b6f5f03c0fe9, {
    "aria-hidden": true,
    tabIndex: 0,
  ...
  }), context.viewport && (0, import_react7.createElement)("span", {
    "aria-owns": contentId
  })));
});
...
var $322c88a641701f3b$export$6893bf21536567da = (0, import_react7.forwardRef)((props, forwardedRef) => {
  const { __scopeNavigationMenu, active, onSelect, ...linkProps } = props;
  return (0, import_react7.createElement)($322c88a641701f3b$var$FocusGroupItem, {
    asChild: true
  }, (0, import_react7.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.a, _extends({
...
var $322c88a641701f3b$export$8ddb526647c0d8fb = (0, import_react7.forwardRef)((props, forwardedRef) => {
  ...
  return context.indicatorTrack ? import_react_dom2.default.createPortal((0, import_react7.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
    present: forceMount || isVisible
  }, (0, import_react7.createElement)($322c88a641701f3b$var$NavigationMenuIndicatorImpl, _extends({}, indicatorProps, {
    ref: forwardedRef
...
var $322c88a641701f3b$var$NavigationMenuIndicatorImpl = (0, import_react7.forwardRef)((props, forwardedRef) => {
  ...
  const [activeTrigger, setActiveTrigger] = (0, import_react7.useState)(null);
  ...
  return position ? (0, import_react7.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({
    "aria-hidden": true,
...
var $322c88a641701f3b$export$38e00e996c2f93f7 = (0, import_react7.forwardRef)((props, forwardedRef) => {
  ...
  return !context.viewport ? (0, import_react7.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
    present: forceMount || open
  }, (0, import_react7.createElement)($322c88a641701f3b$var$NavigationMenuContentImpl, _extends({
    "data-state": $322c88a641701f3b$var$getOpenState(open)
  }, commonProps, {
    ref: composedRefs,
  ...
  }))) : (0, import_react7.createElement)($322c88a641701f3b$var$ViewportContentMounter, _extends({
    forceMount
  }, commonProps, {
    ref: composedRefs
  }));
...
var $322c88a641701f3b$var$ViewportContentMounter = (0, import_react7.forwardRef)((props, forwardedRef) => {
  const context = $322c88a641701f3b$var$useNavigationMenuContext($322c88a641701f3b$var$CONTENT_NAME, props.__scopeNavigationMenu);
...
var $322c88a641701f3b$var$NavigationMenuContentImpl = (0, import_react7.forwardRef)((props, forwardedRef) => {
  ...
  const getItems = $322c88a641701f3b$var$useCollection(__scopeNavigationMenu);
  const prevMotionAttributeRef = (0, import_react7.useRef)(null);
  ...
  const motionAttribute = (0, import_react7.useMemo)(() => {
    const items = getItems();
  ...
  return (0, import_react7.createElement)($322c88a641701f3b$var$FocusGroup, {
    asChild: true
...
var $322c88a641701f3b$export$ee880b97cc6d44a5 = (0, import_react7.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react7.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
    present: forceMount || open
  }, (0, import_react7.createElement)($322c88a641701f3b$var$NavigationMenuViewportImpl, _extends({}, viewportProps, {
    ref: forwardedRef
  })));
});
...
var $322c88a641701f3b$var$NavigationMenuViewportImpl = (0, import_react7.forwardRef)((props1, forwardedRef) => {
  ...
  return (0, import_react7.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({
    ...
    }, (0, import_react7.createElement)($322c88a641701f3b$var$NavigationMenuContentImpl, _extends({}, props, {
...
var $322c88a641701f3b$var$FocusGroup = (0, import_react7.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react7.createElement)($322c88a641701f3b$var$FocusGroupCollection.Provider, {
    scope: __scopeNavigationMenu
  }, (0, import_react7.createElement)($322c88a641701f3b$var$FocusGroupCollection.Slot, {
    scope: __scopeNavigationMenu
  }, (0, import_react7.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({
    dir: context.dir
  }, groupProps, {
...
var $322c88a641701f3b$var$FocusGroupItem = (0, import_react7.forwardRef)((props, forwardedRef) => {
  const { __scopeNavigationMenu, ...groupProps } = props;
  ...
  return (0, import_react7.createElement)($322c88a641701f3b$var$FocusGroupCollection.ItemSlot, {
    scope: __scopeNavigationMenu
  }, (0, import_react7.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.button, _extends({}, groupProps, {
    ref: forwardedRef,
    onKeyDown: $e42e1063c40fb3ef$export$b9ecd428b558ff10(props.onKeyDown, (event) => {
