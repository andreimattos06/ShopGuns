                    ...
                    <form onSubmit={handleSubmit} className="">
                        <div className="grid grid-cols-2 mt-14 text-zinc-200 text-xl">
                            <div className="flex flex-col pr-5 pb-5">
                                ...
                                <Input className="h-96" name='nomeCompleto' id='nomeCompleto' placeholder='José da Silva' defaultValue={String(cadastro?.nomeCompleto)}></Input>
                            </div>

                            <div className='flex flex-col'>
                                <label htmlFor='email' className='font-bold pb-2'>Email:</label>
                                <Input name='email' id='email' placeholder='exemplo@gmail.com' defaultValue={String(cadastro?.email)}></Input>
                            </div>

                            <div className='flex flex-col pr-5 pb-5'>
                                <label htmlFor='password' className='font-bold pb-2'>Senha:</label>
                                <Input name='password' id='password' placeholder='********' defaultValue={String(cadastro?.password)}></Input>
                            </div>

                            <div className='flex flex-col'>
                                <label htmlFor='cpf' className='font-bold pb-2'>CPF:</label>
                                <Input name='cpf' id='cpf' placeholder='111.222.333-44' defaultValue={String(cadastro?.cpf)}></Input>
                            </div>

                            <div className='flex flex-col pr-5 pb-5'>
                                <label htmlFor='logradouro' className='font-bold pb-2'>Logradouro:</label>
                                <Input name='logradouro' id='logradouro' placeholder='Av.' defaultValue={String(cadastro?.logradouro)}></Input>
                            </div>

                            <div className='flex flex-col'>
                                <label htmlFor='endereco' className='font-bold pb-2'>Endereço:</label>
                                <Input name='endereco' id='endereco' placeholder='Jardim dos Ipes' defaultValue={String(cadastro?.endereco)}></Input>
                            </div>

                            <div className='flex flex-col pr-5 pb-5'>
                                <label htmlFor='numero' className='font-bold pb-2'>Numero:</label>
                                <Input name='numero' id='numero' placeholder='22' defaultValue={String(cadastro?.numero)}></Input>
                            </div>

                            <div className='flex flex-col'>
                                <label htmlFor='bairro' className='font-bold pb-2'>Bairro:</label>
                                <Input name='bairro' id='bairro' placeholder='Centro' defaultValue={String(cadastro?.bairro)}></Input>
                            </div>

                            <div className='flex flex-col pr-5 pb-5'>
                                <label htmlFor='cidade' className='font-bold pb-2'>Cidade:</label>
                                <Input name='cidade' id='cidade' placeholder='Caldas Novas' defaultValue={String(cadastro?.cidade)}></Input>
                            </div>

                            <div className='flex flex-col'>
                                <label htmlFor='estado' className='font-bold pb-2'>Estado:</label>
                                <Input name='estado' id='estado' placeholder='Goiás' defaultValue={String(cadastro?.estado)}></Input>
                            </div>

                            <div className='flex flex-col pr-5 pb-16'>
                                <label htmlFor='contato' className='font-bold pb-2'>Contato:</label>
                                <Input name='contato' id='contato' placeholder='(64) 99999-8888' defaultValue={String(cadastro?.contato)}></Input>
                            </div>
